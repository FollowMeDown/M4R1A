...
try {
	...
	statusbox.innerHTML = `Running M4R1A in a normal browser doesn't work. For the full app, see the
	<a href="https://github.com/FollowMeDown/M4R1A/releases">Releases section</a> of the repo.<br><br>
