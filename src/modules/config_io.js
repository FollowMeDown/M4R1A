...
exports.defaults = {
	"warning": "EDITING THIS FILE WHILE M4R1A IS RUNNING WILL GENERALLY CAUSE YOUR EDITS TO BE LOST.",
...
function debork_json(s) {
	...
	for (let n = 0; n < lines.length; n++) {
		...
		if (line.includes(`"path"`) || line.includes(`"WeightsFile"`) || line.includes(`"override_piece_directory"`)) {
			line = replace_all(line, "\\\\", "__M4R1A__blackslash__replacement__in__progress__");
